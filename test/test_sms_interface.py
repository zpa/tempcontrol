...
def test_parse_message():
    ...
    assert parse_message('manual mode') == (Message.MANUAL_MODE, None)
    assert parse_message('Manual Mode') == (Message.MANUAL_MODE, None)
    assert parse_message('MaNuAl MoDe') == (Message.MANUAL_MODE, None)
    assert parse_message('MANUAL MODE') == (Message.MANUAL_MODE, None)
    ...
    assert parse_message('boiler on') == (Message.BOILER_ON, None)
    assert parse_message('Boiler On') == (Message.BOILER_ON, None)
    assert parse_message('BoIlEr On') == (Message.BOILER_ON, None)
    assert parse_message('BOILER ON') == (Message.BOILER_ON, None)    
    assert parse_message('boiler off') == (Message.BOILER_OFF, None)
    assert parse_message('Boiler Off') == (Message.BOILER_OFF, None)
    assert parse_message('BoIlEr OfF') == (Message.BOILER_OFF, None)
    assert parse_message('BOILER OFF') == (Message.BOILER_OFF, None)    
